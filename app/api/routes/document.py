...
from app.core.rag.service import index_chunks
...
async def upload_document(
    ...
    vector_ids = await index_chunks(etl.chunks, doc_id=doc_id)
    if vector_ids:
        chunks_meta = {"vector_ids": vector_ids}
        doc.meta = {**(doc.meta or {}), **chunks_meta}
        await session.commit()

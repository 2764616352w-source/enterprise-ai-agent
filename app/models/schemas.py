...
class ChatResponse(BaseModel):
    ...
    citations: list[Citation] = Field(default_factory=list, description="RAG 引用")
    raw_contexts: list[RetrievalResult] = Field(default_factory=list, description="检索上下文")
    retrieve_mode: str | None = Field(default=None, description="本次检索模式")
